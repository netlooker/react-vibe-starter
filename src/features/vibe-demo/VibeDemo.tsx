...
export const VibeDemo: React.FC = () => {
  const [currentVibe, setCurrentVibe] = useState<
    "fun" | "professional" | "energetic" | "calm"
  >("fun");
  ...
  const conversationSteps = [
    {
      role: "developer",
      text: "I need a button that feels more friendly and approachable.",
    },
    {
      role: "ai",
      text: "I can help with that! Would you like a softer color palette with rounded corners and a subtle hover effect?",
    },
    {
      role: "developer",
      text: "Yes, and maybe add a little bounce effect when it's hovered.",
    },
    {
      role: "ai",
      text: "Great idea! I've added a playful bounce animation and softened the colors. How does this look?",
    },
    {
      role: "developer",
      text: "Perfect! But can we make the transition a bit smoother?",
    },
    {
      role: "ai",
      text: "Done! I've adjusted the transition timing to be more gentle and natural.",
    },
  ];
    ...
    <div className="bg-white dark:bg-gray-900 rounded-lg p-8 shadow-xl border border-gray-100 dark:border-gray-800">
      ...
      <div className="mb-8">
        <p className="text-gray-700 dark:text-gray-300 mb-4">
          Experience how "vibe coding" transforms UI elements by simply
          describing the desired feeling. Select different vibes to see how the
          button changes:
        </p>

        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-6">
          {(["fun", "professional", "energetic", "calm"] as const).map(
            (vibe) => (
              <button
                key={vibe}
        ...
        <div className="flex flex-col items-center justify-center p-8 bg-gray-50 dark:bg-gray-800 rounded-lg">
          ...
          <VibeButton label="Click me!" vibe={currentVibe} />
        </div>
      </div>
